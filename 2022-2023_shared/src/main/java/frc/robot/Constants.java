...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double trackWidth = Units.inchesToMeters(21.40); //TODO: This must be tuned to specific robot
        public static final double wheelBase = Units.inchesToMeters(21.40); //TODO: This must be tuned to specific robot
...
// will be renamed to arm/dart later once code works
    ...
    public static final class TeleOp {
        ...
        public static final double ARM_RUNNER_INITIAL_RUN_SPEED = .8;
        public static final double ARM_RUNNER_INITIAL_REVERSE_SPEED = .8;
